...
public class ServiceRegistryController {
    ...
    @Autowired
    public ServiceRegistryController(RegisteredServiceRepository registeredServiceRepository, ServiceRepository serviceRepository, CloudFoundryOperations cfOps) {
