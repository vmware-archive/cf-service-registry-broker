...
public class ServiceBrokerControllerTest {
    ...
    public void setUp() {
        ...
        serviceBrokerController = new ServiceBrokerController(
                ...
                serviceBindingRepository, registeredServiceRepository);
    }
    ...
    public void createBinding() {
        ...
        when(serviceRepository.findOne("12345")).thenReturn(service);
        ...
        when(registeredServiceRepository.findByName(service.getName())).thenReturn(registeredService);
        ...
        given()
                ...
                .then()
                .statusCode(201)
                .assertThat().body("credentials.uri", equalTo("http://my.url.com"))
                .body("credentials.username", equalTo("tupac"))
                .body("credentials.password", equalTo("makaveli"));

        Credentials newCredentials = new Credentials();
        newCredentials.setUri("http://my.url.com");
        newCredentials.setUsername("tupac");
        newCredentials.setPassword("makaveli");
